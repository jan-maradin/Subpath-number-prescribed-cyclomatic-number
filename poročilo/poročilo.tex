...
poiskala grafe z najmanjšim številom podpoti, torej se nisva osredotočala na geodetske podpoti.

Ker sva grafe iskala za vsa možna ciklomatska števila, je bil postopek iskanja zelo časovno zahteven, 
zato sva se omejila na grafe z največ 9 vozlišči. V prvem delu projektne naloge 
...
Vbistvu naju je zanimalo kako dobro deluje SA, če spremeniva določene parametre. 
...
\begin{itemize}
    ...
    \item pogon kode trajal približno 35 min
...
\begin{itemize}
    ...
    \item \textbf{Ugotovitev:} \\
        ...
        Poleg tega se je pri fiksnem ciklomatskem \v{s}tevilu z dodajanjem novih vozli\v{s}\v{c} maksimalna stopnja grafa zmanj\v{s}evala. To nakazuje, da se maksimalna stopnja grafa pribli\v{z}uje vrednosti $3$, minimalna stopnja pa vrednosti $2$.
