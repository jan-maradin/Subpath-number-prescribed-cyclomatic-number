...
\bigskip
 ...
 \textbf{Ugotovitve:} \\
        ...
        sestavljeni iz ciklov dolžine $3$, kar je razvidno tudi iz slik 8 in 9. Cikli dolžine tri so večinoma imeli eno skupno vozlišče. To se je pojavilo v primerih, ko je bil $\mu \leq 5$ in je bilo na voljo dovolj vozlišč, da so se taki cikli sploh lahko formirali.
...
\textbf{Izrek Knor-a:}\\
V drugem delu projektne naloge sva želela preveriti veljavnost izreka, saj je to predstavljalo edini smiselni način, kako ta izrek vključiti v najino projektno nalogo. 
...
Izrek Knor-a trdi, da mora biti graf z največjim številom podpoti PTC, če je hkrati kaktusen. 
...
\textbf{Ugotovitve} \\
    ...
    Pri maksimiziranju sva ugotovila, da se v veliko primerih oblikejo grafi, v katerih so cikli dolžine štiri povezani zaporedno in skupaj tvorijo verigo, kar je razvidno tudi iz slik 17 in 18.
    \begin{figure}[H]
        \centering
        \begin{minipage}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{../2_del/Geodesic_subpath_number/slike_geodesic_max/graf_geodesic_max_mu3_n14.png}
            \caption{MAX graf za $\mu=3$ in $n=14$}
            \label{fig:max_mu3}
        \end{minipage}\hfill
        \begin{minipage}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{../2_del/Geodesic_subpath_number/slike_geodesic_max/graf_geodesic_max_mu4_n16.png}
            \caption{MAX graf za $\mu=4$ in $n = 16$}
            \label{fig:max_mu4}
        \end{minipage}
    \end{figure}
