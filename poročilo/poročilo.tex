...
\fbox{$n = 8$}
\begin{itemize}
    \item Izvajala sva SA na grafih z 8 vozlišči. Tu sva pregledovala kako spreminjanje temperature in števila korakov vpliva na rezultate in čas trajanja algoritma.
    ...
    \item \textbf{UGOTOVITVE:}
        ...
        \input{../1_del/SA_n8_parametri_csv/povzetek_max_n8.tex}
    ...
    grafov. Poleg tega sva ugotovila, da povišanje začetne temperature ni bistveno izboljšalo iskanja grafa z največjim številom podpoti.
        ...
        \input{../1_del/SA_n8_parametri_csv/povzetek_min_n8.tex}
...
\fbox{$n = 9$}
\begin{itemize}
    \item Za grafe z devetimi vozlišči sva definirala tri različne načine SA-ja, vse pripadajoče datoteke so shranjene v mapi \texttt{1\_del: SA\_n9}, koda pa je zapisana v datoteki \texttt{1del\_SA\_n\_9.ipynb}. 
    \item V prvi načinu SA-ja na grafih z devetimi vozlišči sva začetne začetne približke skonstruirala iz točnih vrednosti, tako da sva vzela graf z osmimi vozlišči in istim ciklomatskim številom, 
        ter mu dodala vozlišče in eno povezavo tako, da je graf ostal povezan. Ko pa sva želela obravnavati graf z ciklomatskim številom, ki je večji od 21 
    ...
    \item Drugi način je bil definiran na podobno kot prvi, razlika je bila le da sva namesto točnih približkov za grafe ze osmimi vozlišči vzela približke, ki sva jih dobila ko sva SA izvedla na grafih velikost $n=8$
    ...
    \item V tretjem načinu pa sva namesto že izračunanih približkov, kot sva to naredila v prejšnih dveh primerih, vzela samo naključni graf z izbranim ciklomatskim številom in devetimi vozlišči, rezultate pa sva zapisala v 
    ...
    \item \textbf{UGOTOVITVE:}
        ...
        \input{../1_del/SA_n9/analiza_v_R_n9/povzetek_min_n9.tex}
    
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\textwidth]{../1_del/SA_n9/analiza_v_R_n9/n9_odmiki_min.png}
            \caption{Graf odmikov pri različnih začetih garfih SA za minimalno število podpoti v grafih z devet vozlišči}
            \label{fig:n9_odmiki_min}
        \end{figure}

        \begin{figure}[H]
            \centering
            \includegraphics[width=1\textwidth]{../1_del/SA_n9/analiza_v_R_n9/n9_relativni_odmiki_min.png}
            \caption{Graf relativnih odmikov pri različnih začetih garfih SA za minimalno število podpoti v grafih z devet vozlišči}
        ...
        \input{../1_del/SA_n9/analiza_v_R_n9/povzetek_max_n9.tex}
    
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\textwidth]{../1_del/SA_n9/analiza_v_R_n9/n9_odmiki_max.png}
            \caption{Graf odmikov pri različnih začetih garfih SA za maksimalno število podpoti v grafih z $n=9$}
        ...
        \begin{figure}[H]
            ...
            \caption{Graf relativnih odmikov pri različnih začetih garfih SA za maksimalno število podpoti v grafih z $n=9$}
            \label{fig:n9_relativni_odmiki_max}
        \end{figure}

        Vsi trije načini so pri iskanju maksimuma imeli veliko manjše raltivne odmike kot pri iskanju minimuma, saj je bil pri maksimumu največji relativni odmik
        približno 5 %, pri minimumu
...
Uporabila sva uporabila podani izrek Knorra in preverila, ali drži. 
...
\begin{itemize}
    ...
    \item \textbf{Ugotovitev:} \\
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\textwidth]{../Grafi_za_porocilo/max_stopnja.png}
        \end{figure}
        ...
        Pri maksimiziranju \v{s}tevila podpoti sva opazila, da je imel pri dobro skonstruiranih grafih vsako vozčišče vsaj stopnjo $2$. To pomeni, da je bilo vsako vozli\v{s}\v{c}e del nekega cikla. 
...
\textbf{Lastnosti:}
 V drugem delu projektne naloge sva prav tako želela preveriti ali Izrek Knor-a zares trdi. 
    V drugem smislu nisva našla smiselne ideje kako bi imelementirata ta izrek v najino projektno nalogo, saj sva midva iskala grafe z največjim in najmanšim številom podpoti na vseh grafi in ne samo na kaktusnih grafih.
    ZA vse grafe v datoteki \texttt{2del\_subpath\_SA.csv}, sva v datoteki \texttt{pregledovanje\_lastnosti\_subpath.ipynb} 
    Zapisovala funkcije, ki za vsak max in vsak min graf ali je kaktusni in ali je PTC graf. Rezulati so zapisani v datoteki \texttt{pregledovanje\_lastnosti\_subpath.csv} 
