...
TO POMOJEM NE RABIVA: Če je $\mu =0$ je graf drevo, saj nima cikov, če pa je $\mu= 1$ imamo enociklični graf.
...
Zgornji izrek lahko torej uporabimo kot "izhodišče", kaseneje pa bomo gledali ne samo kaktusne ampak tudi splošnejše grafe.
...
V okolju SageMath bomo generirali vse povezane grafe z števili vozlišč $n \le 8$ in za vsak graf izračunali:
\[
|V|, \quad |E|, \quad \mu(G), \quad \text{in }p_n(G).
\]
